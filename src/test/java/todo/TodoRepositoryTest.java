...
import com.study.todopartytest.user.UserRepository;
...
class TodoRepositoryTest implements TodoTest {
    ...
    void findAll(){
        ...
        // when
        var resultTodoList = todoRepository.findAll(Sort.by(Direction.DESC, "createDate"));

        // then
        assertThat(resultTodoList.get(0)).isEqualTo(testTodo3);
        assertThat(resultTodoList.get(2)).isEqualTo(testTodo2);
        assertThat(resultTodoList.get(3)).isEqualTo(testTodo1);
    }
